...
|------------------------|--------------------------------------------------------------------|
| Special Attack Aid     | Brief Description Grant an ally a +2 bonus on attacks or           |
| another Bull           | AC Push an opponent back 5 feet or more Move up to                 |
| rush Charge            | twice your speed and attack with +2 bonus Knock a weapon from your |
| Disarm Feint           | opponent's hands Negate your opponent's Dex bonus to               |
| Grapple                | AC Wrestle with an opponent Plow past or over an                   |
| Overrun                | opponent as you move Strike an opponent's weapon or                |
| Sunder Throw splash    | shield Throw container of dangerous liquid at target               |
| weapon Trip            | Trip an opponent Channel positive (or negative) energy to turn     |
| Turn (rebuke) undead   | away (or awe) undead                                               |

...
+-----------------------------------------------+---------------------+
| Familiar (you have visited three or more      | +5                  |
| times)                                        |                     |
+-----------------------------------------------+---------------------+
|                                               |                     |
+-----------------------------------------------+---------------------+
| \*If you have no direct knowledge of your     |                     |
| destination, you must have some connection to |                     |
| it in order to travel there; see below.       |                     |
+-----------------------------------------------+---------------------+
|                                               |                     |
+-----------------------------------------------+---------------------+
...
becomes a full-round action, instead of a standard action, in a *catapsi
*field. If two or more fields of *catapsi *overlap, the effects are not
cumulative.

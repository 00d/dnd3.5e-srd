...
[Other modifiers may apply when the character tries to attract a cohort:]{.underline}
  ...
  **[The Leader . . . ]{.underline}**                                 **[Modifier]{.underline}**
  ...
  [Has a familiar, special mount, or animal companion ]{.underline}   [--2]{.underline}
  [Recruits a cohort of a different alignment]{.underline}            [--1]{.underline}
  [Caused the death of a cohort ]{.underline}                         [--2\*]{.underline}
                                                                      
  [\* Cumulative per cohort killed.]{.underline}                      

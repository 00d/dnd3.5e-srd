...
|                                      |       |                     |
+--------------------------------------+-------+---------------------+
| 1 Each time a victim takes 2 or more |       |                     |
| points of Strength damage from       |       |                     |
| blinding sickness, he or she must    |       |                     |
| make another Fortitude save (using   |       |                     |
| the disease's save DC) or be         |       |                     |
| permanently blinded.                 |       |                     |
+--------------------------------------+-------+---------------------+
|                                      |       |                     |
+--------------------------------------+-------+---------------------+
...
*You can call forth weather appropriate to the climate and season of the
area you are in.

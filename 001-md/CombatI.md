...
+----------------+----------------+----------------+----------------+
| [Colossa       | [--            | [Smal          | [+             |
| l]{.underline} | 8]{.underline} | l]{.underline} | 1]{.underline} |
+----------------+----------------+----------------+----------------+
| [Gargantua     | [--            | [Tin           | [+             |
| n]{.underline} | 4]{.underline} | y]{.underline} | 2]{.underline} |
+----------------+----------------+----------------+----------------+
| [Hug           | [--            | [Diminutiv     | [+             |
| e]{.underline} | 2]{.underline} | e]{.underline} | 4]{.underline} |
+----------------+----------------+----------------+----------------+
| [Larg          | [--            | [Fin           | [+             |
| e]{.underline} | 1]{.underline} | e]{.underline} | 8]{.underline} |
+----------------+----------------+----------------+----------------+
|                |                |                |                |
+----------------+----------------+----------------+----------------+
| [Mediu         | [+             |                |                |
| m]{.underline} | 0]{.underline} |                |                |
+----------------+----------------+----------------+----------------+
|                |                |                |                |
+----------------+----------------+----------------+----------------+
...
**[Minimum Damage:]{.underline}**[ If penalties reduce the damage result
to less than 1, a hit still deals 1 point of damage.]{.underline}
...
a composite bow.]{.underline}

*[Off-Hand Weapon: ]{.underline}*[When you deal damage with a weapon in
your off hand, you add only 1/2 your Strength bonus.]{.underline}

*[Wielding a Weapon Two-Handed: ]{.underline}*[When you deal damage with
...
using a light weapon with two hands.]{.underline}

**[Multiplying Damage:]{.underline}**[ Sometimes you multiply damage by
some factor, such as on a critical hit. Roll the damage (with all
modifiers) multiple times and total the results. ]{.underline}*[Note:
]{.underline}*[When you multiply damage more than once, each multiplier
works off the original, unmultiplied damage.]{.underline}

*[Exception: ]{.underline}*[Extra damage dice over and above a weapon's
normal damage are never multiplied.]{.underline}

**[Ability Damage:]{.underline}**[ Certain creatures and magical effects
...
don't have a Dexterity bonus, nothing happens.)]{.underline}

[Other Modifiers: Many other factors modify your AC.]{.underline}

*[Enhancement Bonuses: ]{.underline}*[Enhancement effects make your
armor better.]{.underline}

*[Deflection Bonus: ]{.underline}*[Magical deflection effects ward off
attacks and improve your AC.]{.underline}

*[Natural Armor: ]{.underline}*[Natural armor improves your
AC.]{.underline}

*[Dodge Bonuses: ]{.underline}*[Some other AC bonuses represent actively
...
stack with each other.]{.underline}

**[Touch Attacks:]{.underline}**[ Some attacks disregard armor,
...
--1, you're dying. When it gets to --10, you're dead.]{.underline}
...
your race and what armor you're wearing.]{.underline}
...
dwarves, who move 20 feet in any armor).]{.underline}

[Humans, elves, half-elves, and half-orcs have a speed of 30 feet (6
squares), or 20 feet (4 squares) in medium or heavy armor.]{.underline}
...
triple if you are in heavy armor).]{.underline}
...
ability modifier ]{.underline}

**[Saving Throw Types:]{.underline}**[ The three different kinds of
saving throws are Fortitude, Reflex, and Will:]{.underline}

*[Fortitude: ]{.underline}*[These saves measure your ability to stand up
...
*[Reflex: ]{.underline}*[These saves test your ability to dodge area
attacks. Apply your Dexterity modifier to your Reflex saving throws.
]{.underline}

*[Will: ]{.underline}*[These saves reflect your resistance to mental
influence as well as many magical effects. Apply your Wisdom modifier to
your Will saving throws.]{.underline}

**[Saving Throw Difficulty Class:]{.underline}**[ The DC for a save is
determined by the attack itself.]{.underline}

**[Automatic Failures and Successes:]{.underline}**[ A natural 1 (the
...
natural 20 (the d20 comes up 20) is always a success.]{.underline}

[INITIATIVE]{.underline}

**[Initiative Checks:]{.underline}**[ At the start of a battle, each
...
changing; see Special Initiative Actions).]{.underline}
...
**[Flat-Footed:]{.underline}**[ At the start of a battle, before you
...
flat-footed.]{.underline}

[A flat-footed character can't make attacks of opportunity.]{.underline}

**[Inaction:]{.underline}**[ Even if you can't take actions, you retain
your initiative score for the duration of the encounter.]{.underline}

[SURPRISE]{.underline}

[When a combat starts, if you are not aware of your opponents and they
are aware of you, you're surprised.]{.underline}
...
are unaware.]{.underline}

[Determining awareness may call for Listen checks, Spot checks, or other
checks.]{.underline}

**[The Surprise Round:]{.underline}**[ If some but not all of the
...
is surprised, no surprise round occurs.]{.underline}

**[Unaware Combatants:]{.underline}**[ Combatants who are unaware at the
...
any Dexterity bonus to AC.]{.underline}
...
+----------------------------------+----------------------------------+
| #### [Table                      |                                  |
| : Actions in Combat]{.underline} |                                  |
+----------------------------------+----------------------------------+
|                                  |                                  |
+----------------------------------+----------------------------------+
| **[Standard                      | **[Attack of                     |
| Action]{.underline}**            | Opportunity                      |
...
+----------------------------------+----------------------------------+
| [Activate a magic item other     | [No]{.underline}                 |
| than a potion or                 |                                  |
| oil]{.underline}                 |                                  |
+----------------------------------+----------------------------------+
| [Aid another]{.underline}        | [Maybe]{                         |
|                                  | .underline}**^[2]{.underline}^** |
+----------------------------------+----------------------------------+
| [Bull rush]{.underline}          | [Yes]{.underline}                |
+----------------------------------+----------------------------------+
| [Cast a spell (1 standard action | [Yes]{.underline}                |
| casting time)]{.underline}       |                                  |
+----------------------------------+----------------------------------+
| [Concentrate to maintain an      | [No]{.underline}                 |
| active spell]{.underline}        |                                  |
+----------------------------------+----------------------------------+
| [Dismiss a spell]{.underline}    | [No]{.underline}                 |
+----------------------------------+----------------------------------+
| [Draw a hidden weapon (see       | [No]{.underline}                 |
| Sleight of Hand                  |                                  |
| skill)]{.underline}              |                                  |
+----------------------------------+----------------------------------+
| [Drink a potion or apply an      | [Yes]{.underline}                |
| oil]{.underline}                 |                                  |
+----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+
| [Light a torch with a            | [Yes]{.underline}                |
| tindertwig]{.underline}          |                                  |
+----------------------------------+----------------------------------+
| [Lower spell                     | [No]{.underline}                 |
| resistance]{.underline}          |                                  |
+----------------------------------+----------------------------------+
| [Make a dying friend stable (see | [Yes]{.underline}                |
| Heal skill)]{.underline}         |                                  |
+----------------------------------+----------------------------------+
| [Overrun]{.underline}            | [No]{.underline}                 |
+----------------------------------+----------------------------------+
| [Read a scroll]{.underline}      | [Yes]{.underline}                |
+----------------------------------+----------------------------------+
| [Ready (triggers a standard      | [No]{.underline}                 |
| action)]{.underline}             |                                  |
+----------------------------------+----------------------------------+
| [Sunder a weapon                 | [Yes]{.underline}                |
| (attack)]{.underline}            |                                  |
+----------------------------------+----------------------------------+
| [Sunder an object                | [Maybe]{                         |
| (attack)]{.underline}            | .underline}**^[3]{.underline}^** |
+----------------------------------+----------------------------------+
| [Total defense]{.underline}      | [No]{.underline}                 |
+----------------------------------+----------------------------------+
| [Turn or rebuke                  | [No]{.underline}                 |
| undead]{.underline}              |                                  |
+----------------------------------+----------------------------------+
| [Use extraordinary               | [No]{.underline}                 |
| ability]{.underline}             |                                  |
+----------------------------------+----------------------------------+
| [Use skill that takes 1          | [Usually]{.underline}            |
| action]{.underline}              |                                  |
+----------------------------------+----------------------------------+
| [Use spell-like                  | [Yes]{.underline}                |
| ability]{.underline}             |                                  |
+----------------------------------+----------------------------------+
| [Use supernatural                | [No]{.underline}                 |
| ability]{.underline}             |                                  |
+----------------------------------+----------------------------------+
| **[Move Action]{.underline}**    | **[Attack of                     |
|                                  | Opportunity                      |
|                                  | ]{.underline}^[1]{.underline}^** |
+----------------------------------+----------------------------------+
| [Move]{.underline}               | [Yes]{.underline}                |
+----------------------------------+----------------------------------+
| [Control a frightened            | [Yes]{.underline}                |
| mount]{.underline}               |                                  |
+----------------------------------+----------------------------------+
| [Direct or redirect an active    | [No]{.underline}                 |
| spell]{.underline}               |                                  |
+----------------------------------+----------------------------------+
| [Draw a                          | [No]{.underline}                 |
| weapon                           |                                  |
...
+----------------------------------+----------------------------------+
| [Load a hand crossbow or light   | [Yes]{.underline}                |
| crossbow]{.underline}            |                                  |
+----------------------------------+----------------------------------+
| [Open or close a                 | [No]{.underline}                 |
| door]{.underline}                |                                  |
+----------------------------------+----------------------------------+
| [Mount a horse or                | [No]{.underline}                 |
| dismount]{.underline}            |                                  |
+----------------------------------+----------------------------------+
| [Move a heavy                    | [Yes]{.underline}                |
| object]{.underline}              |                                  |
+----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+
| [Stand up from                   | [Yes]{.underline}                |
| prone]{.underline}               |                                  |
+----------------------------------+----------------------------------+
| [Ready or loose a                | [No]{.underline}                 |
| shield]{                         |                                  |
| .underline}**^[4]{.underline}^** |                                  |
+----------------------------------+----------------------------------+
| [Retrieve a stored               | [Yes]{.underline}                |
| item]{.underline}                |                                  |
+----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+
| [Load a heavy or repeating       | [Yes]{.underline}                |
| crossbow]{.underline}            |                                  |
+----------------------------------+----------------------------------+
| [Lock or unlock weapon in locked | [Yes]{.underline}                |
| gauntlet]{.underline}            |                                  |
+----------------------------------+----------------------------------+
| [Prepare to throw splash         | [Yes]{.underline}                |
| weapon]{.underline}              |                                  |
+----------------------------------+----------------------------------+
...
| round]{.underline}               |                                  |
+----------------------------------+----------------------------------+
| [Use touch spell on up to six    | [Yes]{.underline}                |
| friends]{.underline}             |                                  |
+----------------------------------+----------------------------------+
| [Withdraw]{                      | [No]{.underline}                 |
| .underline}**^[5]{.underline}^** |                                  |
+----------------------------------+----------------------------------+
| **[Free Action]{.underline}**    | **[Attack of                     |
|                                  | Opportunity                      |
|                                  | ]{.underline}^[1]{.underline}^** |
+----------------------------------+----------------------------------+
| [Cast a quickened                | [No]{.underline}                 |
| spell]{.underline}               |                                  |
+----------------------------------+----------------------------------+
| [Cease concentration on a        | [No]{.underline}                 |
| spell]{.underline}               |                                  |
+----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+
| [Prepare spell components to     | [No]{.underline}                 |
| cast a                           |                                  |
| spell]{                          |                                  |
...
+----------------------------------+----------------------------------+
| [Disarm]{                        | [Yes]{.underline}                |
| .underline}**^[7]{.underline}^** |                                  |
+----------------------------------+----------------------------------+
| [Grapple]{                       | [Yes]{.underline}                |
| .underline}**^[7]{.underline}^** |                                  |
+----------------------------------+----------------------------------+
| [Trip an                         | [Yes]{.underline}                |
| opponent]{                       |                                  |
| .underline}**^[7]{.underline}^** |                                  |
+----------------------------------+----------------------------------+
| [Use                             | [Varies]{.underline}             |
| feat]{                           |                                  |
...
and the multiplier is x2.]{.underline}

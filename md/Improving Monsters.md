...
+-------------+-------------+-------------+-------------+-------------+
|             | ##          | ##### A     | ##          | ##### Ski   |
|             | ### Hit Die | ttack Bonus | ### Good Sa | ll Points\* |
|             |             |             | ving Throws |             |
+-------------+-------------+-------------+-------------+-------------+
...
|             |             | fighter)    | Will        | per HD      |
+-------------+-------------+-------------+-------------+-------------+
| Elemental   | d8          | HD x3/4 (as | Ref (Air,   | 2 + Int mod |
|             |             | cleric)     | Fire), or   | per HD      |
|             |             |             |             |             |
|             |             |             | Fort        |             |
|             |             |             | (Earth,     |             |
|             |             |             | Water)      |             |
...
+-------------------------------------+-------------------------------+
| Aberration, construct, elemental,   | +1 per 4 HD added             |
| fey, giant, humanoid, ooze, plant,  |                               |
| undead, vermin                      |                               |
+-------------------------------------+-------------------------------+
| Animal, magical beast, monstrous    | +1 per 3 HD added             |
| humanoid                            |                               |
+-------------------------------------+-------------------------------+
| Dragon, outsider, nonassociated     | +1 per 2 HD or 2 levels added |
| class levels                        |                               |
+-------------------------------------+-------------------------------+
...
+-------------------------------------+-------------------------------+
| Monster's ability scores based on   | +1 to CR                      |
| elite array\*                       |                               |
+-------------------------------------+-------------------------------+
| Monster possesses special attacks   | +2 to CR                      |
| or qualities that significantly     |                               |
| improve combat effectiveness        |                               |
+-------------------------------------+-------------------------------+
| Monster possesses special attacks   | +1 to CR                      |
| or qualities that improve combat    |                               |
...
|                                     |                               |
+-------------------------------------+-------------------------------+
| \* Do not apply this increase if    |                               |
| you advance a monster by class      |                               |
| levels. (Monsters advanced by class |                               |
| levels are assumed to use the elite |                               |
| array.)                             |                               |
+-------------------------------------+-------------------------------+
|                                     |                               |
+-------------------------------------+-------------------------------+

...
size categories smaller than it is.]{.underline}
...
+----------------------+----------------------+----------------------+
| **[Attacker is . .   | #####                | **Ranged**           |
| .]{.underline}**     |  [Melee]{.underline} |                      |
+----------------------+----------------------+----------------------+
| [                    | [--1]{.underline}    | [--1]{.underline}    |
| Dazzled]{.underline} |                      |                      |
+----------------------+----------------------+----------------------+
| [En                  | [--2]{.underline}*   | [--2]{.underline}*   |
| tangled]{.underline} | *^[1]{.underline}^** | *^[1]{.underline}^** |
+----------------------+----------------------+----------------------+
| [Flanking            | [+2]{.underline}     | [---]{.underline}    |
| d                    |                      |                      |
| efender]{.underline} |                      |                      |
+----------------------+----------------------+----------------------+
| [In                  | [+2]{.underline}*    | [+2]{.underline}*    |
| visible]{.underline} | *^[2]{.underline}^** | *^[2]{.underline}^** |
+----------------------+----------------------+----------------------+
| [On higher           | [+1]{.underline}     | [+0]{.underline}     |
| ground]{.underline}  |                      |                      |
+----------------------+----------------------+----------------------+
| [Prone]{.underline}  | [--4]{.underline}    | [---]{.underline}*   |
|                      |                      | *^[3]{.underline}^** |
+----------------------+----------------------+----------------------+
| [Shaken or           | [--2]{.underline}    | [--2]{.underline}    |
| fri                  |                      |                      |
| ghtened]{.underline} |                      |                      |
+----------------------+----------------------+----------------------+
| [Squeezing through a | [--4]{.underline}    | [--4]{.underline}    |
| space]{.underline}   |                      |                      |
+----------------------+----------------------+----------------------+
|                      |                      |                      |
+----------------------+----------------------+----------------------+
...
+----------------------+----------------------+----------------------+
| #### [Defender i     | ####                 | ####                 |
| s . . .]{.underline} |  [Melee]{.underline} | [Ranged]{.underline} |
+----------------------+----------------------+----------------------+
| [Behind              | [+4]{.underline}     | [+4]{.underline}     |
| cover]{.underline}   |                      |                      |
+----------------------+----------------------+----------------------+
| [                    | [--2]{.underline}*   | [--2]{.underline}*   |
| Blinded]{.underline} | *^[1]{.underline}^** | *^[1]{.underline}^** |
+----------------------+----------------------+----------------------+
|                      |                      |                      |
+----------------------+----------------------+----------------------+
...
|                      |                      |                      |
+----------------------+----------------------+----------------------+
| [C                   | [--2]{.underline}*   | [--2]{.underline}*   |
| owering]{.underline} | *^[1]{.underline}^** | *^[1]{.underline}^** |
+----------------------+----------------------+----------------------+
| [En                  | [+0]{.underline}*    | [+0]{.underline}*    |
| tangled]{.underline} | *^[2]{.underline}^** | *^[2]{.underline}^** |
+----------------------+----------------------+----------------------+
| [Flat-footed (such   | [+0]{.underline}*    | [+0]{.underline}*    |
| as surprised,        | *^[1]{.underline}^** | *^[1]{.underline}^** |
| balancing,           |                      |                      |
| cl                   |                      |                      |
| imbing)]{.underline} |                      |                      |
+----------------------+----------------------+----------------------+
| [Grappling (but      | [+0]{.underline}*    | [                    |
| attacker is          | *^[1]{.underline}^** | +0]{.underline}**^[1 |
| not)]{.underline}    |                      | ,\ 3]{.underline}^** |
+----------------------+----------------------+----------------------+
| [Helpless (such as   | [--4]{.underline}*   | [+0]{.underline}*    |
| paralyzed, sleeping, | *^[4]{.underline}^** | *^[4]{.underline}^** |
| or                   |                      |                      |
| bound)]{.underline}  |                      |                      |
+----------------------+----------------------+----------------------+
| [Kneeling or         | [--2]{.underline}    | [+2]{.underline}     |
| sitting]{.underline} |                      |                      |
+----------------------+----------------------+----------------------+
| [Pinned]{.underline} | [--4]{.underline}*   | [+0]{.underline}*    |
...
+----------------------+----------------------+----------------------+
| [                    | [--2]{.underline}*   | [--2]{.underline}*   |
| Stunned]{.underline} | *^[1]{.underline}^** | *^[1]{.underline}^** |
+----------------------+----------------------+----------------------+
|                      |                      |                      |
+----------------------+----------------------+----------------------+
| [1 The defender      |                      |                      |
...
a creature, the target has cover (+4 to AC).]{.underline}
...
for determining cover from ranged attacks.]{.underline}

**[Low Obstacles and Cover:]{.underline}**[ A low obstacle (such as a
...
cover if he's closer to the obstacle than his target.]{.underline}

**[Cover and Attacks of Opportunity:]{.underline}**[ You can't execute
an attack of opportunity against an opponent with cover relative to
you.]{.underline}

**[Cover and Reflex Saves:]{.underline}**[ Cover grants you a +2 bonus
...
extend around corners and thus negate this cover bonus.]{.underline}

**[Cover and Hide Checks:]{.underline}**[ You can use cover to make a
Hide check. Without cover, you usually need concealment (see below) to
make a Hide check.]{.underline}

**[Soft Cover:]{.underline}**[ Creatures, even your enemies, can provide
...
soft cover allow you to make a Hide check.]{.underline}

**[Big Creatures and Cover:]{.underline}**[ Any creature with a space
...
determine if it has cover against you.]{.underline}

**[Total Cover:]{.underline}**[ If you don't have line of effect to your
target he is considered to have total cover from you. You can't make an
attack against a target that has total cover.]{.underline}

**[Varying Degrees of Cover:]{.underline}**[ In some cases, cover may
...
threatening opponents.]{.underline}
...
that space is occupied, you fall prone in that space.]{.underline}
...
can't charge. (Helpless creatures don't stop a charge.)]{.underline}
...
**[Step 1:]{.underline}**[ Attack of Opportunity. You provoke an attack
...
of opportunity for making the attempt.)]{.underline}

**[Step 2: ]{.underline}**[Opposed Rolls. You and the defender make
...
of +4 per difference in size category.]{.underline}

**[Step 3:]{.underline}**[ Consequences. If you beat the defender, roll
...
you must deal to destroy the weapon or shield.]{.underline}

[If you fail the sunder attempt, you don't deal any damage.]{.underline}

*[Sundering a Carried or Worn Object: ]{.underline}*[You don't use an
...
in this case, you're aiming at the creature.)]{.underline}
...
all creatures in adjacent squares.]{.underline}
...
size, or smaller.]{.underline}

**[Making a Trip Attack:]{.underline}**[ Make an unarmed melee touch
attack against your target. This provokes an attack of opportunity from
your target as normal for unarmed attacks.]{.underline}
...
Strength check to try to trip you.]{.underline}
...
+----------------------------------+----------------------------------+
| #### [Ta                         |                                  |
| ble: Turning Undead]{.underline} |                                  |
+----------------------------------+----------------------------------+
|                                  |                                  |
+----------------------------------+----------------------------------+
| **[Turning Check                 | **[Most Powerful Undead Affected |
| Result]{.underline}**            | (Maximum Hit                     |
|                                  | Dice)]{.underline}**             |
+----------------------------------+----------------------------------+
| [0 or lower]{.underline}         | [Cleric's level --               |
|                                  | 4]{.underline}                   |
+----------------------------------+----------------------------------+
| [1--3]{.underline}               | [Cleric's level --               |
|                                  | 3]{.underline}                   |
+----------------------------------+----------------------------------+
| [4--6]{.underline}               | [Cleric's level --               |
|                                  | 2]{.underline}                   |
+----------------------------------+----------------------------------+
| [7--9]{.underline}               | [Cleric's level --               |
|                                  | 1]{.underline}                   |
+----------------------------------+----------------------------------+
...
destroyed are commanded.]{.underline}

**[Rebuked:]{.underline}**[ A rebuked undead creature cowers as if in
awe (attack rolls against the creature get a +2 bonus). The effect lasts
10 rounds.]{.underline}

**[Commanded:]{.underline}**[ A commanded undead creature is under the
...
undead creature or creatures in order to command new ones.]{.underline}

**[Dispelling Turning:]{.underline}**[ An evil cleric may channel
...
**[Bolstering Undead:]{.underline}**[ An evil cleric may also bolster
...
undead cleric can bolster himself in this manner.]{.underline}
...
+----------------------+----------------------+----------------------+
| #### [Circum         | #### [Prima          | #### [O              |
| stances]{.underline} | ry Hand]{.underline} | ff Hand]{.underline} |
+----------------------+----------------------+----------------------+
| [Normal              | [--6]{.underline}    | [--10]{.underline}   |
| pe                   |                      |                      |
| nalties]{.underline} |                      |                      |
+----------------------+----------------------+----------------------+
| [Off-hand weapon is  | [--4]{.underline}    | [--8]{.underline}    |
| light]{.underline}   |                      |                      |
+----------------------+----------------------+----------------------+
| [Two-Weapon Fighting | [--4]{.underline}    | [--4]{.underline}    |
| feat]{.underline}    |                      |                      |
+----------------------+----------------------+----------------------+
|                      |                      |                      |
+----------------------+----------------------+----------------------+
| [Off-hand weapon is  | [--2]{.underline}    | [--2]{.underline}    |
...
**[Double Weapons]{.underline}**[: You can use a double weapon to make
...
the weapon were a light weapon.]{.underline}

**[Thrown Weapons:]{.underline}**[ The same rules apply when you throw a
...
place in the initiative order.]{.underline}
...
fixing your new initiative count at that point.]{.underline}
...
with a readied action).]{.underline}

**[Initiative Consequences of Delaying: ]{.underline}**[Your initiative
...
get to take a delayed action (though you can delay again).]{.underline}
...
that you ready might do so).]{.underline}

**[Readying an Action:]{.underline}**[ You can ready a standard action,
...
readied action.]{.underline}

[You can take a 5-foot step as part of your readied action, but only if
you don't otherwise move any distance during the round. ]{.underline}

**[Initiative Consequences of Readying:]{.underline}**[ Your initiative
...
that round.]{.underline}

**[Distracting Spellcasters:]{.underline}**[ You can ready an attack
...
cast (as determined by her Concentration check result).]{.underline}

**[Readying to Counterspell:]{.underline}**[ You may ready a
...
and the other arcane.]{.underline}

[A spellcaster can use ]{.underline}*[dispel magic ]{.underline}*[to
counterspell another spellcaster, but it doesn't always
work.]{.underline}

**[Readying a Weapon against a Charge:]{.underline}**[ You can ready
...
against a charging character.]{.underline}

...
+----------------------------------------+----------------------------+
| Quickened spell (limit one quickened   | +28                        |
| action/round)                          |                            |
+----------------------------------------+----------------------------+
...
+----------------------------------------+----------------------------+
| Permanent duration (apply this factor  | x5                         |
| after all other epic spell factors but |                            |
...
+----------------------------------------+----------------------------+
| Change from target to area (pick area  | +10                        |
| option below)                          |                            |
+----------------------------------------+----------------------------+
| Change from personal to area (pick     | +15                        |
| area option below)                     |                            |
+----------------------------------------+----------------------------+
| Change from target to touch or ray     | +4                         |
| (300-ft. range)                        |                            |
+----------------------------------------+----------------------------+
...
| ### *Area*^4^                          |                            |
+----------------------------------------+----------------------------+
| Change area to bolt (5 ft. x300 ft. or | +2                         |
| 10 ft. x150 ft.)                       |                            |
+----------------------------------------+----------------------------+
...
+----------------------------------------+----------------------------+
| Change area to touch or ray (close     | +4                         |
| range)                                 |                            |
+----------------------------------------+----------------------------+
...
| ### Spell Resistance                   |                            |
+----------------------------------------+----------------------------+
| Gain +1 bonus on caster level check to | +2                         |
| overcome target's spell resistance     |                            |
+----------------------------------------+----------------------------+
| Gain +1 on caster level check to beat  | +2                         |
| foe's dispel effect                    |                            |
+----------------------------------------+----------------------------+
| ### Other                              |                            |
+----------------------------------------+----------------------------+
...
|                                        |                            |
+----------------------------------------+----------------------------+
| Increase damage die by one step (d20   | +10                        |
| maximum)                               |                            |
+----------------------------------------+----------------------------+
|                                        |                            |
+----------------------------------------+----------------------------+
...
| 20,000 XP)                       |                                  |
+----------------------------------+----------------------------------+
| Increase casting time by 1       | --2                              |
| minute (max 10 minutes)**^2^**   |                                  |
+----------------------------------+----------------------------------+
...
+------------+--------------------+------------+--------------------+
| **Undead** | ######## Spel      | **Undead** | **Spellcraft DC    |
|            | lcraft DC Modifier |            | Modifier**         |
+------------+--------------------+------------+--------------------+
|            |                    |            |                    |
+------------+--------------------+------------+--------------------+
...
or 10-ft.-radius spherical emanation, centered on you
...
+----------------+----------------+----------------+----------------+
|                | **Base         |                | **Base         |
|                | Psicraft DC**  |                | Psicraft DC**  |
+----------------+----------------+----------------+----------------+
|                |                |                |                |
+----------------+----------------+----------------+----------------+
| ##### Ps       |                | #              |                |
| ychometabolism |                | #### Telepathy |                |
+----------------+----------------+----------------+----------------+
...
|                                          |                          |
+------------------------------------------+--------------------------+
| Hide visual display (epic psionic seeds  | +4                       |
| substitute one Vi display for V and S    |                          |
| components)                              |                          |
+------------------------------------------+--------------------------+
|                                          |                          |
+------------------------------------------+--------------------------+
...
**Effect: **A demiplane coterminous with the Ethereal Plane, centered on
your location

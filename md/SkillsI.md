...
| Acid                         | Alchemy**^1^ ** | 15                |
+------------------------------+-----------------+-------------------+
| Alchemist's fire,            | Alchemy**^1^ ** | 20                |
| smokestick, or tindertwig    |                 |                   |
+------------------------------+-----------------+-------------------+
| Antitoxin, sunrod,           | Alchemy**^1^ ** | 25                |
| tanglefoot bag, or           |                 |                   |
| thunderstone                 |                 |                   |
+------------------------------+-----------------+-------------------+
...
| composite shortbow with high |                 |                   |
| strength rating              |                 |                   |
+------------------------------+-----------------+-------------------+
| Crossbow                     | Weaponsmithing  | 15                |
+------------------------------+-----------------+-------------------+
| Simple melee or thrown       | Weaponsmithing  | 12                |
| weapon                       |                 |                   |
+------------------------------+-----------------+-------------------+
| Martial melee or thrown      | Weaponsmithing  | 15                |
| weapon                       |                 |                   |
+------------------------------+-----------------+-------------------+
| Exotic melee or thrown       | Weaponsmithing  | 18                |
| weapon                       |                 |                   |
+------------------------------+-----------------+-------------------+
| Mechanical trap              | Trapmaking      | Varies**^2^**     |
+------------------------------+-----------------+-------------------+
| Very simple item (wooden     | Varies          | 5                 |
| spoon)                       |                 |                   |
+------------------------------+-----------------+-------------------+
...
|                              |                 |                   |
+------------------------------+-----------------+-------------------+
| 1 You must be a spellcaster  |                 |                   |
| to craft any of these items. |                 |                   |
+------------------------------+-----------------+-------------------+
|                              |                 |                   |
+------------------------------+-----------------+-------------------+
| 2 Traps have their own rules |                 |                   |
| for construction.            |                 |                   |
+------------------------------+-----------------+-------------------+
|                              |                 |                   |
+------------------------------+-----------------+-------------------+
...
+---------------------------------------+-----------------------------+
| Disguised as different age            | --2**^2^**                  |
| category**^1^**                       |                             |
+---------------------------------------+-----------------------------+
|                                       |                             |
+---------------------------------------+-----------------------------+
| ^1^These modifiers are cumulative;    |                             |
| use any that apply.                   |                             |
+---------------------------------------+-----------------------------+
|                                       |                             |
+---------------------------------------+-----------------------------+
| ^2^Per step of difference between     |                             |
| your actual age category and your     |                             |
| disguised age category. The steps     |                             |
| are: young (younger than adulthood),  |                             |
| adulthood, middle age, old, and       |                             |
| venerable.                            |                             |
+---------------------------------------+-----------------------------+
|                                       |                             |
+---------------------------------------+-----------------------------+

...
older dungeons, used to create animal pens, storage bins, or just to
make a number of smaller rooms out of a larger one.

**Magically Treated Walls:*** *These walls are stronger than average,
with a greater hardness, more hit points, and a higher break DC. Magic
can usually double the hardness and hit points and can add up to 20 to
the break DC. A magically treated wall also gains a saving throw against
...
+----------+----------+----------+----------+----------+----------+
| **Door   | *        | **Ha     | **Hit    | *        | **       |
| Type**   | *Typical | rdness** | Points** | *Stuck** | Locked** |
|          | Thi      |          |          |          |          |
|          | ckness** |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| Simple   | 1 in.    | 5        | 10 hp    | 13       | 15       |
| wooden   |          |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| Good     | 1-1/2    | 5        | 15 hp    | 16       | 18       |
| wooden   | in.      |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| Strong   | 2 in.    | 5        | 20 hp    | 23       | 25       |
| wooden   |          |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
...
+----------+----------+----------+----------+----------+----------+
| Por      | 3 in     | 5        | 30 hp    | 2        | 2        |
| tcullis, |          |          |          | 5**^1^** | 5**^1^** |
| wooden   |          |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| Por      | 2 in.    | 10       | 60 hp    | 2        | 2        |
| tcullis, |          |          |          | 5**^1^** | 5**^1^** |
| iron     |          |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| Lock     | ---      | 15       | 30 hp    |          |          |
...
+-------------+-------------+-------------+-------------+-------------+
| **          | **Slashing  | #### Tail   | *           | **Off       |
| Condition** | or          |             | *Movement** | Ba          |
|             | Bl          |             |             | lance?^4^** |
|             | udgeoning** |             |             |             |
+-------------+-------------+-------------+-------------+-------------+
| *Freedom of | no          | no          | normal      | No          |
| movement*   | rmal/normal | rmal/normal |             |             |
+-------------+-------------+-------------+-------------+-------------+
| Has a swim  | --2/half    | normal      | normal      | No          |
| speed       |             |             |             |             |
+-------------+-------------+-------------+-------------+-------------+
| Successful  | --2/        | --2/half    | quarter or  | No          |
| Swim check  | half**^1^** |             | half**^2^** |             |
+-------------+-------------+-------------+-------------+-------------+
| Firm        | --2/half    | --2/half    | half        | No          |
| foo         |             |             |             |             |
| ting**^3^** |             |             |             |             |
+-------------+-------------+-------------+-------------+-------------+
| None of the | --2/half    | --2/half    | normal      | Yes         |
| above       |             |             |             |             |
+-------------+-------------+-------------+-------------+-------------+
|             |             |             |             |             |
+-------------+-------------+-------------+-------------+-------------+
...
a city and delving into a dungeon is that a dungeon is, almost by
...
+----------+----------+----------+----------+----------+----------+
| ###      | **Cost   | **       | **Cr     | **Range  | *        |
| ### Item | **       | Damage** | itical** | Inc      | *Typical |
|          |          |          |          | rement** | Crew**   |
+----------+----------+----------+----------+----------+----------+
| C        | 800 gp   | 6d6      | ---      | 200 ft.  | 4        |
| atapult, |          |          |          | (100 ft. |          |
| heavy    |          |          |          | minimum) |          |
+----------+----------+----------+----------+----------+----------+
| C        | 550 gp   | 4d6      | ---      | 150 ft.  | 2        |
| atapult, |          |          |          | (100 ft. |          |
| light    |          |          |          | minimum) |          |
+----------+----------+----------+----------+----------+----------+
...
Use the guidelines in the Jump skill* *(a horizontal jump's peak height
is one-fourth of the horizontal distance) to determine whether a
character can make a jump.
...
|          |          |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| **Wind   | **Wind   | **Ranged | **       | **Wind   | **Fort   |
| Force**  | Speed**  | Attacks  | Creature | Effect   | Save     |
|          |          | Norm     | Size^2^  | on       | DC**     |
|          |          | al/Siege | **       | Cre      |          |
|          |          | Weap     |          | atures** |          |
|          |          | ons^1^** |          |          |          |
...
|          | mph      |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| Moderate | 11--20   | ---/---  | Any      | None     | ---      |
|          | mph      |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| Strong   | 21--30   | --2/---  | Tiny or  | Knocked  | 10       |
|          | mph      |          | smaller  | down     |          |
+----------+----------+----------+----------+----------+----------+
|          |          |          | Small or | None     |          |
|          |          |          | larger   |          |          |
+----------+----------+----------+----------+----------+----------+
| Severe   | 31--50   | --4/---  | Tiny     | Blown    | 15       |
|          | mph      |          |          | away     |          |
+----------+----------+----------+----------+----------+----------+
|          |          |          | Small    | Knocked  |          |
|          |          |          |          | down     |          |
...
|          |          |          | larger   |          |          |
+----------+----------+----------+----------+----------+----------+
| W        | 51--74   | Imposs   | Small or | Blown    | 18       |
| indstorm | mph      | ible/--4 | smaller  | away     |          |
+----------+----------+----------+----------+----------+----------+
|          |          |          | Medium   | Knocked  |          |
|          |          |          |          | down     |          |
+----------+----------+----------+----------+----------+----------+
...
|          |          |          | Colossal |          |          |
+----------+----------+----------+----------+----------+----------+
| H        | 75--174  | Imposs   | Medium   | Blown    | 20       |
| urricane | mph      | ible/--8 | or       | away     |          |
|          |          |          | smaller  |          |          |
+----------+----------+----------+----------+----------+----------+
|          |          |          | Large    | Knocked  |          |
|          |          |          |          | down     |          |
...
|          |          |          | Colossal |          |          |
+----------+----------+----------+----------+----------+----------+
| Tornado  | 175--300 | Impos    | Large or | Blown    | 30       |
|          | mph      | sible/im | smaller  | away     |          |
|          |          | possible |          |          |          |
+----------+----------+----------+----------+----------+----------+
|          |          |          | Huge     | Knocked  |          |
|          |          |          |          | down     |          |
...
fires* *might find their clothes, hair, or equipment on fire. Spells
with an instantaneous duration* *don't normally set a character on fire,
since the heat and flame from these come and go in a flash.

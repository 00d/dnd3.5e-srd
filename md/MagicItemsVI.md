...
+----------+----------+----------+----------+----------+----------+
| **d%**   | **Mental | *        | #####    | **       | **Base   |
|          | Ability  | *Communi | ### Capa | Senses** | Price    |
|          | Scores** | cation** | bilities |          | Mo       |
|          |          |          |          |          | difier** |
+----------+----------+----------+----------+----------+----------+
|          |          |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 01--34   | Two at   | Empath   | One      | 30 ft.   | +1,000   |
|          | 12,      | y**^1^** | lesser   | vision   | gp       |
|          |          |          | power    | and      |          |
|          | one at   |          |          | hearing  |          |
|          | 10       |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 35--59   | Two at   | Empath   | Two      | 60 ft.   | +2,000   |
|          | 13,      | y**^1^** | lesser   | vision   | gp       |
|          |          |          | powers   | and      |          |
|          | one at   |          |          | hearing  |          |
|          | 10       |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 60--79   | Two at   | Speec    | Two      | 120 ft.  | +4,000   |
|          | 14,      | h**^2^** | lesser   | vision   | gp       |
|          |          |          | powers   | and      |          |
|          | one at   |          |          | hearing  |          |
|          | 10       |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 80--91   | Two at   | Speec    | Three    | 60 ft.   | +5,000   |
|          | 15,      | h**^2^** | lesser   | da       | gp       |
|          |          |          | powers   | rkvision |          |
|          | one at   |          |          |          |          |
|          | 10       |          |          | and      |          |
|          |          |          |          | hearing  |          |
+----------+----------+----------+----------+----------+----------+
| 92--97   | Two at   | Speech** | Three    | 60 ft.   | +6,000   |
|          | 16,      | ^2\ 3^** | lesser   | da       | gp       |
|          |          |          | powers   | rkvision |          |
|          | one at   |          |          |          |          |
|          | 10       |          |          | and      |          |
|          |          |          |          | hearing  |          |
+----------+----------+----------+----------+----------+----------+
| 98       | Two at   | Speech,  | Three    | 120 ft.  | +9,000   |
|          | 17,      | telepat  | lesser   | da       | gp       |
|          |          | hy^\ ^** | powers   | rkvision |          |
|          | one at   | ^3\ 4^** |          |          |          |
|          | 10       |          | and one  | and      |          |
|          |          |          | greater  | hearing  |          |
...
|          |          |          | r**^6^** |          |          |
+----------+----------+----------+----------+----------+----------+
| 99       | Two at   | Speech,  | Three    | 120 ft.  | +12,000  |
|          | 18,      | telepat  | lesser   | dar      | gp       |
|          |          | hy^\ ^** | powers   | kvision, |          |
|          | one at   | ^4\ 5^** |          | bli      |          |
|          | 10       |          | and two  | ndsense, |          |
|          |          |          | greater  | and      |          |
...
|          |          |          | s**^6^** |          |          |
+----------+----------+----------+----------+----------+----------+
| 100      | Two at   | Speech,  | Four     | 120 ft.  | +15,000  |
|          | 19,      | t        | lesser   | dar      | gp       |
|          |          | elepathy | powers   | kvision, |          |
|          | one at   | **       |          | bli      |          |
|          | 10       | ^4\ 5^** | and      | ndsense, |          |
|          |          |          | three    | and      |          |
|          |          |          | greater  | hearing  |          |
...
|                         | image *1/day            |                |
+-------------------------+-------------------------+----------------+
| 78--80                  | Item can cast *darkness | +6,500 gp      |
|                         | *3/day                  |                |
+-------------------------+-------------------------+----------------+
...
|                        | will                   |                 |
+------------------------+------------------------+-----------------+
| 65--68                 | Item can use *haste    | +16,000 gp      |
|                        | *on its owner 3/day    |                 |
+------------------------+------------------------+-----------------+
| 69--73                 | Item can create        | +16,000 gp      |
|                        | *daylight *3/day       |                 |
+------------------------+------------------------+-----------------+
| 74--76                 | Item can create        | +16,000 gp      |
|                        | *deeper darkness       |                 |
|                        | *3/day                 |                 |
+------------------------+------------------------+-----------------+
...
|                      |                      |  Base Price Modifier |
+----------------------+----------------------+----------------------+
| 01--06               | Item can use *ice    | +50,000 gp           |
|                      | storm*               |                      |
+----------------------+----------------------+----------------------+
| 07--12               | Item can use         | +50,000 gp           |
|                      | *confusion*          |                      |
+----------------------+----------------------+----------------------+
| 13--17               | Item can use         | +50,000 gp           |
|                      | *phantasmal killer*  |                      |
+----------------------+----------------------+----------------------+
| 18--24               | Item can use         | *+*50,000 gp         |
|                      | *crushing despair*   |                      |
+----------------------+----------------------+----------------------+
| 25--31               | Item can use         | +50,000 gp           |
|                      | *dimension door *on  |                      |
|                      | itself and wielder   |                      |
+----------------------+----------------------+----------------------+
| 32--36               | Item can use         | +56,000 gp           |
|                      | *contagion           |                      |
|                      | *(heightened to 4th  |                      |
|                      | level) as touch      |                      |
|                      | attack               |                      |
+----------------------+----------------------+----------------------+
| 37--43               | Item can use *poison | +56,000 gp           |
|                      | *(heightened to 4th  |                      |
|                      | level) as touch      |                      |
|                      | attack               |                      |
+----------------------+----------------------+----------------------+
| 44--50               | Item can use         | +56,000 gp           |
|                      | *rusting grasp *as   |                      |
|                      | touch attack         |                      |
+----------------------+----------------------+----------------------+
| 51--56               | Item can cast 10d6   | *+*60,000 gp         |
|                      | *lightning bolt*     |                      |
+----------------------+----------------------+----------------------+
| 57--62               | Item can cast 10d6   | *+*60,000 gp         |
|                      | *fireball*           |                      |
+----------------------+----------------------+----------------------+
| 63--68               | Wielder gets +2 luck | +80,000 gp           |
|                      | bonus on attacks,    |                      |
|                      | saves, and checks    |                      |
+----------------------+----------------------+----------------------+
| 69--74               | Item can use *mass   | *+*81,000 gp         |
|                      | inflict light        |                      |
|                      | wounds*              |                      |
+----------------------+----------------------+----------------------+
| 75--81               | Item can use *song   | *+*81,000 gp         |
|                      | of discord*          |                      |
+----------------------+----------------------+----------------------+
| 82--87               | Item can use *prying | *+*81,000 gp         |
|                      | eyes*                |                      |
+----------------------+----------------------+----------------------+
| 88--92               | Item can cast 15d6   | +130,000 gp          |
|                      | *greater shout       |                      |
|                      | *3/day               |                      |
+----------------------+----------------------+----------------------+
| 93--98               | Item can use *waves  | *+*164,000 gp        |
|                      | of exhaustion*       |                      |
+----------------------+----------------------+----------------------+
|                      |                      |                      |
+----------------------+----------------------+----------------------+
| 99--100              | Item can use *true   | +200,000 gp          |
|                      | resurrection *on     |                      |
|                      | wielder, once per    |                      |
|                      | month                |                      |
+----------------------+----------------------+----------------------+
...
| **d%**               | **Item**             | ###### Market Price |
+----------------------+----------------------+---------------------+
| 01--05               | *Incense of          | 200 gp              |
|                      | obsession *          |                     |
+----------------------+----------------------+---------------------+
| 06--15               | *Ring of clumsiness  | 500 gp              |
|                      | *                    |                     |
+----------------------+----------------------+---------------------+
| 16--20               | *Amulet of           | 1,000 gp            |
|                      | inescapable location |                     |
|                      | *                    |                     |
+----------------------+----------------------+---------------------+
| 21--25               | *Stone of weight *   | 1,000 gp            |
+----------------------+----------------------+---------------------+
| 26--30               | *Bracers of          | 1,200 gp            |
|                      | defenselessness *    |                     |
+----------------------+----------------------+---------------------+
| 31--35               | *Gauntlets of        | 1,300 gp            |
|                      | fumbling *           |                     |
+----------------------+----------------------+---------------------+
...
+----------------------+----------------------+---------------------+
| 44--46               | *Medallion of        | 1,800 gp            |
|                      | thought projection * |                     |
+----------------------+----------------------+---------------------+
| 47--52               | *Flask of curses *   | 2,100 gp            |
+----------------------+----------------------+---------------------+
| 53--54               | *Dust of sneezing    | 2,400 gp            |
|                      | and choking *        |                     |
+----------------------+----------------------+---------------------+
| 55                   | *Helm of opposite    | 4,000 gp            |
|                      | alignment *          |                     |
+----------------------+----------------------+---------------------+
| 56--60               | *Potion of poison *  | 5,000 gp            |
+----------------------+----------------------+---------------------+
| 61                   | *Broom of animated   | 5,200 gp            |
|                      | attack *             |                     |
+----------------------+----------------------+---------------------+
| 62--63               | *Robe of             | 5,500 gp            |
|                      | powerlessness *      |                     |
+----------------------+----------------------+---------------------+
| 64                   | *Vacuous grimoire *  | 6,000 gp            |
+----------------------+----------------------+---------------------+
| 65--68               | *Spear, cursed       | 7,500 gp            |
|                      | backbiter *          |                     |
+----------------------+----------------------+---------------------+
| 69--70               | *Armor of arrow      | 9,000 gp            |
|                      | attraction *         |                     |
+----------------------+----------------------+---------------------+
...
+----------------------+----------------------+---------------------+
| 86--88               | *Periapt of foul     | 17,000 gp           |
|                      | rotting *            |                     |
+----------------------+----------------------+---------------------+
...
|                      | ball *               |                     |
+----------------------+----------------------+---------------------+
| 98                   | *Necklace of         | 60,000 gp           |
|                      | strangulation *      |                     |
+----------------------+----------------------+---------------------+
| 99                   | *Cloak of            | 62,000 gp           |
|                      | poisonousness *      |                     |
+----------------------+----------------------+---------------------+
|                      |                      |                     |
+----------------------+----------------------+---------------------+
...
|                                        |                            |
+----------------------------------------+----------------------------+
| Caster employing a spell usable by own | 10%                        |
| class and level                        |                            |
+----------------------------------------+----------------------------+
| Caster employing a spell not usable by | 20%                        |
| own class and level                    |                            |
+----------------------------------------+----------------------------+
...
|                |                |                |                |
+----------------+----------------+----------------+----------------+
| **Plaque**     | **Tarot Card** | **Playing      | **Summary of   |
|                |                | Card**         | Effect**       |
+----------------+----------------+----------------+----------------+
| Balance        | XI\. Justice   | Two of spades  | Change         |
|                |                |                | alignment      |
|                |                |                | instantly.     |
+----------------+----------------+----------------+----------------+
| Comet          | Two of swords  | Two of         | Defeat the     |
|                |                | diamonds       | next monster   |
|                |                |                | you meet to    |
|                |                |                | gain one       |
|                |                |                | level.         |
+----------------+----------------+----------------+----------------+
| Donjon         | Four of swords | Ace of spades  | You are        |
|                |                |                | *imprisoned*.  |
+----------------+----------------+----------------+----------------+
| Euryale        | Ten of swords  | Queen of       | --1 penalty on |
|                |                | spades         | all saving     |
|                |                |                | throws         |
|                |                |                | henceforth.    |
+----------------+----------------+----------------+----------------+
| The Fates      | Three of cups  | Ace of hearts  | Avoid any      |
|                |                |                | situation you  |
|                |                |                | choose . . .   |
|                |                |                | once.          |
+----------------+----------------+----------------+----------------+
| Flames         | XV\. The Devil | Queen of clubs | Enmity between |
|                |                |                | you and an     |
|                |                |                | outsider.      |
+----------------+----------------+----------------+----------------+
| Fool           | 0\. The Fool   | Joker (with    | Lose 10,000    |
|                |                | trademark)     | experience     |
|                |                |                | points and you |
|                |                |                | must draw      |
|                |                |                | again.         |
+----------------+----------------+----------------+----------------+
| Gem            | Seven of cups  | Two of hearts  | Gain your      |
|                |                |                | choice of      |
|                |                |                | twenty-five    |
|                |                |                | pieces of      |
|                |                |                | jewelry or     |
|                |                |                | fifty gems.    |
+----------------+----------------+----------------+----------------+
| Idiot          | Two of         | Two of clubs   | Lose           |
|                | pentacles      |                | Intelligence   |
|                |                |                | (permanent     |
|                |                |                | drain). You    |
|                |                |                | may draw       |
|                |                |                | again.         |
+----------------+----------------+----------------+----------------+
| Jester         | XII\. The      | Joker (without | Gain 10,000 XP |
|                | Hanged Man     | trademark)     | or two more    |
|                |                |                | draws from the |
|                |                |                | deck.          |
+----------------+----------------+----------------+----------------+
| Key            | V. The         | Queen of       | Gain a major   |
|                | Hierophant     | hearts         | magic weapon.  |
+----------------+----------------+----------------+----------------+
| Knight         | Page of swords | Jack of hearts | Gain the       |
|                |                |                | service of a   |
|                |                |                | 4th-level      |
|                |                |                | fighter.       |
+----------------+----------------+----------------+----------------+
| Moon           | XVIII\. The    | Queen of       | You are        |
|                | Moon           | diamonds       | granted 1d4    |
|                |                |                | wishes.        |
+----------------+----------------+----------------+----------------+
| Rogue          | Five of swords | Jack of spades | One of your    |
|                |                |                | friends turns  |
|                |                |                | against you.   |
+----------------+----------------+----------------+----------------+
| Ruin           | XVI\. The      | King of spades | Immediately    |
|                | Tower          |                | lose all       |
|                |                |                | wealth and     |
|                |                |                | real property. |
+----------------+----------------+----------------+----------------+
| Skull          | XIII\. Death   | Jack of clubs  | Defeat dread   |
|                |                |                | wraith or be   |
|                |                |                | forever        |
|                |                |                | destroyed.     |
+----------------+----------------+----------------+----------------+
| Star           | XVII\. The     | Jack of        | Immediately    |
|                | Star           | diamonds       | gain a +2      |
|                |                |                | inherent bonus |
|                |                |                | to one ability |
|                |                |                | score.         |
+----------------+----------------+----------------+----------------+
| Sun            | XIX\. The Sun  | King of        | Gain           |
|                |                | diamonds       | beneficial     |
|                |                |                | medium         |
|                |                |                | wondrous item  |
|                |                |                | and 50,000 XP. |
+----------------+----------------+----------------+----------------+
| Talons         | Queen of       | Ace of clubs   | All magic      |
|                | pentacles      |                | items you      |
|                |                |                | possess        |
|                |                |                | disappear      |
|                |                |                | permanently.   |
+----------------+----------------+----------------+----------------+
| Throne         | Four of staves | King of hearts | Gain a +6      |
|                |                |                | bonus on       |
|                |                |                | Diplomacy      |
|                |                |                | checks plus a  |
|                |                |                | small keep.    |
+----------------+----------------+----------------+----------------+
| Vizier         | IX\. The       | Ace of         | Know the       |
|                | Hermit         | diamonds       | answer to your |
|                |                |                | next dilemma.  |
+----------------+----------------+----------------+----------------+
|                |                |                |                |
+----------------+----------------+----------------+----------------+
| The Void       | Eight of       | King of clubs  | Body           |
|                | swords         |                | functions, but |
|                |                |                | soul is        |
|                |                |                | trapped        |
|                |                |                | elsewhere.     |
+----------------+----------------+----------------+----------------+

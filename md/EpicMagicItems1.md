...
magic items* *has a higher market price than indicated by the formulas
for non-epic items.
...
|                         |                         |                |
+-------------------------+-------------------------+----------------+
| 57--62                  | Specific armor or       |                |
|                         | shield **^3\ ^**        |                |
+-------------------------+-------------------------+----------------+
|                         |                         |                |
+-------------------------+-------------------------+----------------+
| 63--75                  | Armor with special      |                |
|                         | ability and roll again  |                |
|                         | **^4^ **                |                |
+-------------------------+-------------------------+----------------+
| 76--98                  | Shield with special     |                |
|                         | ability and roll        |                |
|                         | again** ^4^ **          |                |
+-------------------------+-------------------------+----------------+
|                         |                         |                |
...
|                         |                         |                |
+-------------------------+-------------------------+----------------+
| 1 Roll also on nonepic  |                         |                |
| magic item Table:       |                         |                |
| Shield Special          |                         |                |
| Abilities.              |                         |                |
+-------------------------+-------------------------+----------------+
| 2 Roll also on nonepic  |                         |                |
| magic item Table: Armor |                         |                |
| Special Abilities.      |                         |                |
+-------------------------+-------------------------+----------------+
| 3 Roll on Table:        |                         |                |
| Specific Epic Magic     |                         |                |
...
+-------------------------+-------------------------+----------------+
| 100                     | Roll again and add +10  | **^2^**        |
|                         | to bonus **^1^**        |                |
+-------------------------+-------------------------+----------------+
|                         |                         |                |
+-------------------------+-------------------------+----------------+
| 1 This is cumulative if |                         |                |
...
| bonuses higher than     |                         |                |
| +20, the market price   |                         |                |
| modifier is equal to    |                         |                |
| the square of the bonus |                         |                |
| x10,000 gp.             |                         |                |
+-------------------------+-------------------------+----------------+
|                         |                         |                |
+-------------------------+-------------------------+----------------+
...
|                       |                       |                    |
+-----------------------+-----------------------+--------------------+
| All magic shields are |                       |                    |
| masterwork shields    |                       |                    |
| (with an armor check  |                       |                    |
| penalty 1 lower than  |                       |                    |
| normal).              |                       |                    |
+-----------------------+-----------------------+--------------------+
|                       |                       |                    |
+-----------------------+-----------------------+--------------------+
...
|                      | (10/epic)            |                      |
+----------------------+----------------------+----------------------+
| 68--72               | Great spell          | +7 bonus             |
|                      | resistance (SR 23)   |                      |
+----------------------+----------------------+----------------------+
| 73--76               | Great spell          | +8 bonus             |
|                      | resistance (SR 25)   |                      |
+----------------------+----------------------+----------------------+
| 77--79               | Great spell          | +9 bonus             |
|                      | resistance (SR 27)   |                      |
+----------------------+----------------------+----------------------+
|                      |                      |                      |
+----------------------+----------------------+----------------------+
| 80--87               | Roll on nonepic      |                      |
|                      | magic item Table:    |                      |
|                      | Armor Special        |                      |
|                      | Abilities, then roll |                      |
|                      | again on this table. |                      |
...
+----------------------+----------------------+----------------------+
| **d%**               | **Shield Special     | # Marke              |
|                      | Ability**            | t Price Modifier ^1^ |
+----------------------+----------------------+----------------------+
|                      |                      |                      |
+----------------------+----------------------+----------------------+
| 01--06               | Great                | +4 bonus             |
...
|                      | (5/epic)             |                      |
+----------------------+----------------------+----------------------+
| 38--43               | Great spell          | +6 bonus             |
|                      | resistance (SR 21)   |                      |
+----------------------+----------------------+----------------------+
| 44--46               | Infinite arrow       | +6 bonus             |
|                      | deflection           |                      |
+----------------------+----------------------+----------------------+
...
|                      | (10/epic)            |                      |
+----------------------+----------------------+----------------------+
| 64--68               | Great spell          | +7 bonus             |
|                      | resistance (SR 23)   |                      |
+----------------------+----------------------+----------------------+
| 69--71               | Exceptional arrow    | +8 bonus             |
|                      | deflection           |                      |
+----------------------+----------------------+----------------------+
| 72--75               | Great spell          | +8 bonus             |
|                      | resistance (SR 25)   |                      |
+----------------------+----------------------+----------------------+
| 76--78               | Great spell          | +9 bonus             |
|                      | resistance (SR 27)   |                      |
+----------------------+----------------------+----------------------+
...
of fait*h); *Market Price: *5,220,325 gp; *Cost to Create: *2,610,325
gp + 52,200 XP.
...
*creator must be able to turn undead; *Market Price: *3,580,308 gp;
*Cost to Create: *1,790,308 gp + 45,800 XP.

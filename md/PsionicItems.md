...
+----------------------------------+----------------------------------+
| ####### Tabl                     |                                  |
| e: Magic--Psionics Equivalencies |                                  |
+----------------------------------+----------------------------------+
|                                  |                                  |
+----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+
| *Pearl of power*                 | Treat in all ways as a           |
|                                  | *cognizance crystal *with power  |
|                                  | point capacity appropriate to    |
|                                  | the equivalent power level       |
+----------------------------------+----------------------------------+
| *Crystal ball *                  | Substitute power for spell       |
+----------------------------------+----------------------------------+
| *Ioun stones*                    |                                  |
+----------------------------------+----------------------------------+
| Vibrant purple                   | Stores three levels of psionic   |
|                                  | powers                           |
+----------------------------------+----------------------------------+
| Pale lavender                    | Absorbs powers up to 4th level   |
|                                  | (burns out as normal)            |
+----------------------------------+----------------------------------+
| Rainbow**^1^**                   | Provides 5 power points per day  |
|                                  | (regenerates)                    |
+----------------------------------+----------------------------------+
| Dull gray**^2^**                 | Provides 1 power point to a      |
|                                  | psionic character, then          |
|                                  | disintegrates                    |
+----------------------------------+----------------------------------+
|                                  |                                  |
+----------------------------------+----------------------------------+
| 1 New item: Treat as a           |                                  |
| *cognizance crystal *in *ioun    |                                  |
| stone *form, except that it      |                                  |
| regenerates its stored power     |                                  |
| points each day; Price 16,000    |                                  |
| gp.                              |                                  |
+----------------------------------+----------------------------------+
|                                  |                                  |
+----------------------------------+----------------------------------+
| 2 Dull gray stones are useless   |                                  |
| for magic but still harbor just  |                                  |
| enough resonance that a psionic  |                                  |
| character can eke out 1 power    |                                  |
| point before the stone is gone   |                                  |
| forever.                         |                                  |
+----------------------------------+----------------------------------+
|                                  |                                  |
+----------------------------------+----------------------------------+
...
Estimating Magic Item Gold Piece Value,* *substituting "spell" for
...
+----------------------+----------+---------+----------------------+
| 01--02               | 01--05   | 01--05  | Armor, possibly with |
|                      |          |         | special ability      |
+----------------------+----------+---------+----------------------+
| 03--04               | 06--10   | 06--10  | Shield, possibly     |
|                      |          |         | with special ability |
+----------------------+----------+---------+----------------------+
| 05--06               | 11--15   | 11--15  | Melee weapon,        |
|                      |          |         | possibly with        |
|                      |          |         | special ability      |
+----------------------+----------+---------+----------------------+
| 08--09               | 16--20   | 16--20  | Ranged weapon,       |
|                      |          |         | possibly with        |
|                      |          |         | special ability      |
+----------------------+----------+---------+----------------------+
...
+--------------+------------+-----------+--------------+--------------+
| 98           | 67--75     | 31--40    | Power        | +2           |
|              |            |           | resistance   | bonus**^1^** |
|              |            |           | (13)         |              |
+--------------+------------+-----------+--------------+--------------+
| 99           | 76--83     | 41--50    | Ectoplasmic  | +10,800 gp   |
+--------------+------------+-----------+--------------+--------------+
| ---          | 84--89     | 51--60    | Gleaming     | +3           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| ---          | 90--94     | 61--70    | Power        | +3           |
|              |            |           | resistance   | bonus**^1^** |
...
+--------------+------------+-----------+--------------+--------------+
| 35--60       | 06--10     | 04--05    | Ranged       | +1           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| 61--89       | 11--15     | 06--10    | Linked       | +6,000 gp    |
+--------------+------------+-----------+--------------+--------------+
| 90--97       | 16--35     | 11--24    | Power        | +2           |
|              |            |           | resistance   | bonus**^1^** |
|              |            |           | (13)         |              |
+--------------+------------+-----------+--------------+--------------+
...
+--------------+------------+-----------+--------------+--------------+
| 01--15       | 01--10     | ---       | P            | +1           |
|              |            |           | sychokinetic | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| 16--45       | 11--25     | 01--09    | Dissipater   | +1           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| 46--55       | 26--30     | 10--12    | Lucky        | +1           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| 56--70       | 31--40     | 13--17    | Sundering    | +1           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| 71--80       | 41--46     | 18--21    | Power        | +1           |
|              |            |           | storing      | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| 81--99       | 51--56     | 22--30    | Collision    | +2           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| ---          | 57--65     | 31--37    | Mindcrusher  | +2           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| ---          | 66--71     | 38--41    | P            | +2           |
|              |            |           | sychokinetic | bonus**^1^** |
|              |            |           | burst        |              |
+--------------+------------+-----------+--------------+--------------+
| ---          | 72--75     | 42--49    | Suppression  | +2           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| ---          | 76--78     | 50--58    | Psibane      | +2           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
...
+--------------+------------+-----------+--------------+--------------+
| ---          | 86--88     | 66--71    | Bodyfeeder   | +3           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| ---          | 89--91     | 72--77    | Mindfeeder   | +3           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| ---          | 92--93     | 78--83    | Soulbreaker  | +3           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
...
|              |            |           | sychokinetic | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| 41--100      | 31--45     | 01--30    | Collision    | +2           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
...
|              |            |           | burst        |              |
+--------------+------------+-----------+--------------+--------------+
| ---          | 67--74     | 66--69    | Psibane      | +2           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| ---          | 75--78     | 70--73    | Manifester   | +16,000 gp   |
+--------------+------------+-----------+--------------+--------------+
| ---          | 79--82     | 74--79    | Dislocator   | +3           |
|              |            |           |              | bonus**^1^** |
+--------------+------------+-----------+--------------+--------------+
| ---          | 83--98     | 80--90    | Great        | +4           |
|              |            |           | dislocator   | bonus**^1^** |
...
|               |          |         |               |               |
+---------------+----------+---------+---------------+---------------+
| # Minor       | # Medium | # Major | # M           | #             |
|               |          |         | aximum Power  |  Market Price |
|               |          |         | Point Storage |               |
+---------------+----------+---------+---------------+---------------+
|               |          |         |               |               |
+---------------+----------+---------+---------------+---------------+
...
|             |             |           |             |             |
+-------------+-------------+-----------+-------------+-------------+
| **Minor**   | **Medium**  | **Major** | **Power     | **Market    |
|             |             |           | Level**     | Price^1^**  |
+-------------+-------------+-----------+-------------+-------------+
| 01--50      | ---         | ---       | 1st         | 25 gp       |
+-------------+-------------+-----------+-------------+-------------+
...
|                      |                      | ####### Market Price |
+----------------------+----------------------+----------------------+
| 01--04               | *Shard *(+1, any one | 10 gp                |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 05--07               | *Shard *(+2, any one | 40 gp                |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 08--10               | Crawling tattoo (any | 50 gp                |
|                      | 1st level)           |                      |
+----------------------+----------------------+----------------------+
| 11--14               | *Crawling tattoo of  | 50 gp                |
|                      | concussion*          |                      |
+----------------------+----------------------+----------------------+
| 15--18               | *Shard *(+3, any one | 90 gp                |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 19--21               | *Shard *(+4, any one | 160 gp               |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 22--24               | *Shard *(+5, any one | 250 gp               |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 25--28               | Crawling tattoo (any | 300 gp               |
|                      | 2nd level)           |                      |
+----------------------+----------------------+----------------------+
| 29--31               | *Pearl, brain lock*  | 300 gp               |
+----------------------+----------------------+----------------------+
| 32--35               | *Shard *(+6, any one | 360 gp               |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 36--38               | *Shard *(+7, any one | 490 gp               |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 39--41               | *Boots of stomping*  | 600 gp               |
+----------------------+----------------------+----------------------+
| 42--44               | *Shard *(+8, any one | 640 gp               |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 45--47               | Crawling tattoo (any | 750 gp               |
|                      | 3rd level)           |                      |
+----------------------+----------------------+----------------------+
| 48--50               | *Crawling tattoo of  | 750 gp               |
|                      | energy bolt*         |                      |
+----------------------+----------------------+----------------------+
| 51--53               | *Pearl, breath       | 750 gp               |
|                      | crisis*              |                      |
+----------------------+----------------------+----------------------+
| 54--56               | *Shard *(+9, any one | 810 gp               |
|                      | skill)               |                      |
+----------------------+----------------------+----------------------+
| 57--59               | *Boots of landing *  | 1,000 gp             |
+----------------------+----------------------+----------------------+
| 60--63               | *Psionic restraints, | 1,000 gp             |
|                      | lesser*              |                      |
+----------------------+----------------------+----------------------+
| 64--67               | *Shard *(+10, any    | 1,000 gp             |
|                      | one skill)           |                      |
+----------------------+----------------------+----------------------+
| 68--71               | *Pearl, personality  | 1,400 gp             |
|                      | parasite*            |                      |
+----------------------+----------------------+----------------------+
| 72--75               | *Crystal mask of     | 2,500 gp             |
|                      | knowledge*           |                      |
+----------------------+----------------------+----------------------+
| 76--79               | *Crystal mask of     | 2,500 gp             |
|                      | languages*           |                      |
+----------------------+----------------------+----------------------+
| 80--85               | *Eyes of expanded    | 3,000 gp             |
|                      | vision*              |                      |
+----------------------+----------------------+----------------------+
| 86--89               | *Gloves of object    | 3,000 gp             |
|                      | reading*             |                      |
+----------------------+----------------------+----------------------+
| 90--92               | *Mirror of           | 3,600 gp             |
|                      | suggestion*          |                      |
+----------------------+----------------------+----------------------+
| 93--94               | *Psionic restraints, | 6,000 gp             |
|                      | average*             |                      |
+----------------------+----------------------+----------------------+
...
|                      |                      | ####### Market Price |
+----------------------+----------------------+----------------------+
| 01--04               | *Psionatrix of       | 8,000 gp             |
|                      | clairsentience*      |                      |
+----------------------+----------------------+----------------------+
| 05--08               | *Psionatrix of       | 8,000 gp             |
|                      | metacreativity*      |                      |
+----------------------+----------------------+----------------------+
| 09--12               | *Psionatrix of       | 8,000 gp             |
|                      | psychokinesis*       |                      |
+----------------------+----------------------+----------------------+
| 13--16               | *Psionatrix of       | 8,000 gp             |
|                      | psychometabolism*    |                      |
+----------------------+----------------------+----------------------+
| 17--20               | *Psionatrix of       | 8,000 gp             |
|                      | psychoportation*     |                      |
+----------------------+----------------------+----------------------+
| 21--25               | *Psionatrix of       | 8,000 gp             |
|                      | telepathy*           |                      |
+----------------------+----------------------+----------------------+
| 26--27               | *Third eye           | 8,000 gp             |
|                      | penetrate*           |                      |
+----------------------+----------------------+----------------------+
| 28--29               | *Mirror of time hop* | 9,000 gp             |
+----------------------+----------------------+----------------------+
| 30--31               | *Crystal mask of     | 10,000 gp            |
|                      | detection*           |                      |
+----------------------+----------------------+----------------------+
| 32--33               | *Crystal mask of     | 10,000 gp            |
|                      | discernment*         |                      |
+----------------------+----------------------+----------------------+
| 34--35               | *Crystal mask of     | 10,000 gp            |
|                      | dread*               |                      |
+----------------------+----------------------+----------------------+
| 36--38               | *Crystal mask of     | 10,000 gp            |
|                      | psionic craft*       |                      |
+----------------------+----------------------+----------------------+
| 39--41               | *Ring of             | 10,000 gp            |
|                      | self-sufficiency*    |                      |
+----------------------+----------------------+----------------------+
...
+----------------------+----------------------+----------------------+
| 46--47               | *Third eye           | 10,000 gp            |
|                      | concentrate*         |                      |
+----------------------+----------------------+----------------------+
| 48--49               | *Third eye gather*   | 10,000 gp            |
+----------------------+----------------------+----------------------+
| 50--52               | *Eyes of power       | 10,080 gp            |
|                      | leech*               |                      |
+----------------------+----------------------+----------------------+
| 53--55               | *Third eye           | 10,080 gp            |
|                      | powerthieve*         |                      |
+----------------------+----------------------+----------------------+
| 56--58               | *Third eye view*     | 10,180 gp            |
+----------------------+----------------------+----------------------+
| 59--61               | *Crystal mask of     | 10,667 gp            |
|                      | mindarmor*           |                      |
+----------------------+----------------------+----------------------+
| 62--63               | *Psionic restraints, | 12,000 gp            |
|                      | greater*             |                      |
+----------------------+----------------------+----------------------+
| 64--65               | *Torc of leech       | 12,000 gp            |
|                      | freedom*             |                      |
+----------------------+----------------------+----------------------+
| 66--68               | *Gloves of titan's   | 14,000 gp            |
|                      | grip*                |                      |
+----------------------+----------------------+----------------------+
...
+----------------------+----------------------+----------------------+
| 73--74               | *Skin of the         | 18,000 gp            |
|                      | chameleon*           |                      |
+----------------------+----------------------+----------------------+
| 75--76               | *Pearl, mind seed*   | 18,500 gp            |
+----------------------+----------------------+----------------------+
| 77--78               | *Mirror of mind      | 19,800 gp            |
|                      | switch*              |                      |
+----------------------+----------------------+----------------------+
| 79--80               | *Eyes of power       | 20,160 gp            |
|                      | leech, vampiric*     |                      |
+----------------------+----------------------+----------------------+
| 81--82               | *Crystal mask of     | 20,250 gp            |
|                      | insightful           |                      |
|                      | detection*           |                      |
+----------------------+----------------------+----------------------+
| 83--84               | *Crystal anchor,     | 24,000 gp            |
|                      | body*                |                      |
+----------------------+----------------------+----------------------+
| 85--86               | *Crystal anchor,     | 24,000 gp            |
|                      | comprehension*       |                      |
+----------------------+----------------------+----------------------+
| 87--88               | *Crystal anchor,     | 24,000 gp            |
|                      | creation*            |                      |
+----------------------+----------------------+----------------------+
| 89--90               | *Crystal anchor,     | 24,000 gp            |
|                      | energy*              |                      |
+----------------------+----------------------+----------------------+
| 91                   | *Crystal anchor,     | 24,000 gp            |
|                      | ghost*               |                      |
+----------------------+----------------------+----------------------+
| 92--93               | *Crystal anchor,     | 24,000 gp            |
|                      | mind*                |                      |
+----------------------+----------------------+----------------------+
| 94--95               | *Crystal anchor,     | 24,000 gp            |
|                      | travel*              |                      |
+----------------------+----------------------+----------------------+
| 96--97               | *Psionic restraints, | 24,000 gp            |
|                      | damping*             |                      |
+----------------------+----------------------+----------------------+
|                      |                      |                      |
+----------------------+----------------------+----------------------+
...
|                      |                      | ####### Market Price |
+----------------------+----------------------+----------------------+
| 01--08               | *Skin of the         | 32,000 gp            |
|                      | defender*            |                      |
+----------------------+----------------------+----------------------+
| 09--16               | *Torc of power       | 36,000 gp            |
|                      | preservation*        |                      |
+----------------------+----------------------+----------------------+
| 17--24               | *Boots of temporal   | 43,200 gp            |
|                      | acceleration*        |                      |
+----------------------+----------------------+----------------------+
| 25--32               | *Third eye           | 43,200 gp            |
|                      | repudiate*           |                      |
+----------------------+----------------------+----------------------+
| 33--40               | *Skin of fiery       | 60,000 gp            |
|                      | response*            |                      |
+----------------------+----------------------+----------------------+
...
Moderate psychometabolism; ML 7th; Craft Universal Item, *metamorphosis;
...
Strong clairsentience; ML 17th; Craft Universal Item, *power resistance;
...
formularize. Refer to Table: Estimating Magic Item Gold Piece Values*
